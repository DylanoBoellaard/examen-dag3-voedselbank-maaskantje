...
<body>
    <main>
        ...
        <form action="" method="get">
            ...
            <div>
                <select for="selector" name="selector" id="selector">
                    <option value="">Selecteer Eetwens</option>
                    @foreach($eetwens as $eetwens)
        ...
        <div class="layout">
            <table>
                ...
                @if($gezinnen->isEmpty() || empty($gezinnen))
                <tr>
                        <td class="error-tekst" colspan="7">Er zijn geen gezinnen bekent die de geselecteerde eetwens hebben</td>
                </tr>
                @else
                ...
                <tr>
                    ...
                    <td>{{ $persoon->isVertegenwoordiger}}</td>
                    <td><a href="/voedselpakket/gezin/{{ $gezin->id }}"><svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 224 225" width="224" height="225">
                                <title>boxicon</title>
                                <defs>
